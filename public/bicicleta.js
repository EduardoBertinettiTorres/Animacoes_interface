!(function (t, e) {
  ...
  function y(t, e = "rgb(0, 0, 0)") {
    ...
    const n = (function (t) {
      ...
      return `rgb(${r(n.groups.red)}, ${r(n.groups.green)}, ${r(
        n.groups.blue
      )})`;
    })(t);
    return n === e ? f(e) : n;
  ...
  function X(t, e, n) {
    return 0 === t ? e : 1 === t ? n : { x: Z(t, e.x, n.x), y: Z(t, e.y, n.y) };
  }
  function K(t, e, n) {
    ...
    It = {
      ...
      i: function (t, e, n) {
        return 0 === t
          ...
          : 1 === t
          ? n
          : { width: Z(t, e.width, n.width), height: Z(t, e.height, n.height) };
      },
      u: (t, e) => (n) => {
        const r = e(n);
  ...
  function Ct(t, e, n, r, i = !1) {
    ...
    return (
      s || (s = { x: Vt(t.x, e.x, n.x, r), y: Vt(t.y, e.y, n.y, r) }),
      i &&
  ...
  function Dt(t, e, n, r, i, s = !1) {
    let o = Ot(t, e, n, r, i);
    return (
      o || (o = { x: Pt(t.x, e.x, n.x, r.x, i), y: Pt(t.y, e.y, n.y, r.y, i) }),
      s &&
  ...
  function Lt(t, e, n, r = !1) {
    if (zt(e)) {
      ...
      if (Wt(e))
        return Gt(n) ? Dt(e, e.end, n.start, n, t, r) : Ct(e, e.end, n, t, r);
      if (Gt(n)) return Ct(e, n.start, n, t, r);
    }
    return Ft(e, n, t, r);
  }
          ...
          case "g":
            if (e.r === n.r) {
              ...
              return (
                ...
                e.c
                  ? ((i.c = Q(t, e.c, n.c)), (i.rd = Z(t, e.rd, n.rd)))
  ...
  function re(t, e, n) {
    return { o: J(t, e.o, n.o || 0), c: tt(t, e.c, n.c || {}) };
  }
  function ie(t) {
    ...
    animations: [
      {
        elements: {
          evzMfuopHER2: {
            transform: {
              data: {
                o: { x: 640.000141, y: 366.505314, type: "corner" },
                s: { x: -0.050435, y: 0.060852 },
                t: { x: -6399.999544, y: -3663.355227 },
              },
              keys: {
                r: [
                  { t: 0, v: 180 },
        ...
        s: "|",
      },
    ],
    options: "MADAxMDg4MmY4MFA4MTHZlV1Q3ZjgxMmY0NzJFmNzk3YzZlRzcxMmY4BYQ|",
  },
  "__SVGATOR_PLAYER__",
  window,
  document
